...
totalCost = rentCost + utilitiesCost + foodCost + transporationCost + computerCost;
if (( totalCost ) < budget) {
    console.log("Total cost: " + totalCost);
} else {
    alert("The total cost is: " + totalCost + ", which is more than the budget amount.");
...
if ((rentCost > (utilitiesCost + foodCost + transporationCost)) && ( computerCost > (rentCost + utilitiesCost))) {
