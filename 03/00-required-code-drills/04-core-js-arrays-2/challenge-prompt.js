...
for (var i = 0; i < numArray.length; i++) {
  ...
  if (numArray[i] == 11) {
    alert("There is a eleven at index: " + i);
  }
...
console.log("Sum of numArray values that are greater than 50: " + sum);
...
for (var i = 0; i < fruits.length; i++) {
  ...
  console.log("Apple appears " + sum + " times.");
...
for (var i = 0; i < fruits.length; i++) {
  ...
  console.log("Peach appears " + sum + " times.");
...
for (var i = 0; i < fruits.length; i++) {
  ...
  console.log(sum + " fruits start with a P.");
...
console.log("Original Fruits Array Length: " + fruits.length);
console.log("Unique Fruits array length: " + uniqueFruits.length);
...
for (var i = 0; i < twoDimArray[0].length; i++) {
  if (twoDimArray[0][i] < 25 ) {
    console.log ( twoDimArray[0][i] + " < 25");
  }
}
...
for (var i = 0; i < twoDimArray[1].length; i++) {
  if (twoDimArray[1][i] < 25 ) {
    console.log ( twoDimArray[1][i] + " < 25");
  }
}
...
for (var i = 0; i < twoDimArray[2].length; i++) {
  if (twoDimArray[2][i] < 25 ) {
    console.log ( twoDimArray[2][i] + " < 25");
  }
}
...
for (var i = 0; i < twoDimArray[3].length; i++) {
  if (twoDimArray[3][i] < 25 ) {
    console.log ( twoDimArray[3][i] + " < 25");
  }
}
...
for (var i = 0; i < twoDimArray[4].length; i++) {
  if (twoDimArray[4][i] < 25 ) {
    console.log ( twoDimArray[4][i] + " < 25");
  }
}
  ...
  for (var j = 0; j < twoDimArray[i].length; j++) {
   // console.log(twoDimArray[i][j]);
    if (twoDimArray[i][j] % 2) {
      console.log(twoDimArray[i][j] + "is an odd number.");
    }
  }
}
  ...
  for (var j = 0; j < twoDimArray[i].length; j++) {
   // console.log(twoDimArray[i][j]);
    if (twoDimArray[i][j] % 3 == 0) {
      console.log(twoDimArray[i][j] + "is a multiple of 3.");
    }
  }
}
